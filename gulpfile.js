...
gulp.task('renders-files-copy', function () {
    return gulp
        .src([
            'src/renders/**/visualisation.html',
            'src/renders/**/preview.html',
            'src/renders/**/preview_uat1.html',
            'src/renders/**/preview_uat1_mobile.html',
            'src/renders/**/templates/*.html',
            'src/renders/**/js/*.js'
        ])
...
gulp.task('minify_reusable' ,function() {
    return gulp.src([reusable, '!./dist/reusable/showdown.min.js', '!./dist/reusable/lory.js','!./dist/reusable/carouselLoader_v2cd.js'])
