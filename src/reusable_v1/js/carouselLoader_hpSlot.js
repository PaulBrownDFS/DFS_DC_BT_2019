    ...
    contentTree.carouselslot.spec = {
      ...
      for (s = 0; s < contentTree.carouselslot.slides.length; s++) {
        ...
        if (contentTree.carouselslot.slides[s].priceLabel) {
          ...
          if (p.length > 1) {
            contentTree.carouselslot.slides[s].priceLabel[1] = contentTree.carouselslot.spec.roi ? p[1] : p[0];
          }
          ...
          for (x = 2; x < 5; x++) {
            ...
            if (a.length > 1) {
              contentTree.carouselslot.slides[s].priceLabel[x] = contentTree.carouselslot.spec.roi ? (a[0].split('£')[0] + a[1]) : a[0];
            }
          ...
          if (contentTree.carouselslot.spec.roi) {
            contentTree.carouselslot.slides[s].priceLabel[7] = '€' + (pp / 36).toFixed(3).toString().slice(0, -1) + ' a month for 3 years';
          } else {
            contentTree.carouselslot.slides[s].priceLabel[7] = '£' + (pp / 48).toFixed(3).toString().slice(0, -1) + ' a month for 4 years';
          }

          // build desktop finance details

          if (contentTree.carouselslot.slides[s].priceLabel && contentTree.carouselslot.slides[s].priceLabel[7]) {
            contentTree.carouselslot.slides[s].financeArray = contentTree.carouselslot.slides[s].priceLabel[7].split(' a month ');
